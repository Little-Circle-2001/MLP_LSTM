...
for i in range(N_data):
    ...
    result = ocp_cvx(stm_i, cim_i, psi_i, state_roe_0, n_time_rpod)
    states_roe_cvx_i, actions_cvx_i, feas_cvx_i = result
    ...
    if np.char.equal(feas_cvx_i,'optimal'):
        ...
        result1 = solve_scp(stm_i, cim_i, psi_i, state_roe_0, states_roe_cvx_i, n_time_rpod)
        states_roe_scp_i = result1[0]
        actions_scp_i = result1[1]
        feas_scp_i = result1[2]
