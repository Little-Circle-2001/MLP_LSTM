...
transformer_model_name = 'checkpoint_MLP_LSTM'
...
if not scenario_test_dataset:
    ...
    # np.savez_compressed('..\dataset\dataset-rpod-stats.npz', states_std=data_stats['states_std'],states_mean=data_stats['states_mean'], actions_mean=data_stats['actions_mean'], actions_std=data_stats['actions_std'])
    hrz = horizons.item()
